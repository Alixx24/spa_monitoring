...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var formData, response, data, tbody_1, newRow, error_1;
    ...
    if (tbody) {
        tbody.addEventListener('click', function (event) { return __awaiter(void 0, void 0, void 0, function () {
            var target, id, response, data, row, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        target = event.target;
                        ...
                        if (!id)
                            return [2 /*return*/];
                        if (!confirm('آیا از حذف این مورد مطمئنی؟'))
                            return [2 /*return*/];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, fetch("/panel/duration/delete/".concat(id), {
                                method: 'POST',
                                headers: {
                    ...
                    case 3:
                        data = _a.sent();
                        if (data.success) {
                            row = document.querySelector("tr[data-row-id=\"".concat(id, "\"]"));
                            if (row)
                                row.remove();
                        }
                        return [3 /*break*/, 5];
